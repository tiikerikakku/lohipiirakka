...
class TestKauppa(unittest.TestCase):
    ...
    def test_4(self):
        ...
        pankki_mock.tilisiirto.assert_called_with('pekka', ANY, '12345', ANY, 4)
    ...
    def test_5(self):
        ...
        pankki_mock.tilisiirto.assert_called_with(ANY, ANY, ANY, ANY, 0)
